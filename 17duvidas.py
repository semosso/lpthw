...
# SO: "the file descriptor you open with open(to_file) will be closed automatically; file sessions are closed after the file-objects exit the scope
# (in this case, immediately after .write())."
